...
if ([string](Get-ObjectProperty $schema "active_schema_version" "") -notin @("2.5.0", "2.5.1", "2.5.2")) {
    throw "Latest metadata is not a supported schema (2.5.0, 2.5.1 or 2.5.2): $($metadataFile.Name)"
}
