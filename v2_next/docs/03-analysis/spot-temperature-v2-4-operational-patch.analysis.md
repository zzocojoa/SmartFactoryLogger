...
- `pre_changeover_hold_candidate` post-hoc confirmation now requires future evidence; false general-stop candidates become `posthoc_rejected`, and idle/production-only IDs are excluded from changeover facts.
