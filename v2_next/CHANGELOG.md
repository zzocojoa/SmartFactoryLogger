...
- Prioritized terminal failures during persistence saturation, deferred final
  journal close until all SPOT producers drain, and made corrupt recovery lines
  fail open without blocking startup.
