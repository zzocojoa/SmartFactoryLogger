...
const SECTION_FIELD_MAP: Record<string, Array<keyof SettingsFormState>> = {
  ...
  'settings-spot': [
    ...
    'spotImageCapturePath',
    'spotImageCaptureMinIntervalSec',
    'spotImageCaptureMaxBytes',
    'spotImageCaptureRetentionDays',
  ...
  'settings-storage': [
    ...
    'snapshotPath',
    'autoSave',
    'operatorMetadataDowntimeResetHours',
    'intervalSec',
    'statusWarnMs',
    'statusOfflineMs',
  ],
...
const LABEL_MAP: Record<keyof SettingsFormState, string> = {
  ...
  spotImageCaptureEnabled: 'SPOT image capture',
  spotImageCaptureMode: 'SPOT image capture mode',
  spotImageCapturePath: 'SPOT image capture path',
  spotImageCaptureMinIntervalSec: 'SPOT image capture min interval',
  spotImageCaptureMaxBytes: 'SPOT image capture max bytes',
  spotImageCaptureRetentionDays: 'SPOT image capture retention',
  spotImageCaptureLinkToObservation: 'SPOT image capture observation link',
  ...
  autoSave: '자동 저장',
  operatorMetadataDowntimeResetHours: CONFIG_LABELS.OPERATOR_METADATA_DOWNTIME_RESET,
  intervalSec: '수집 간격 (초)',
...
const APPLY_KEY_LABELS: Record<string, string> = {
  ...
  'settings.operator_metadata_downtime_reset_hours': CONFIG_LABELS.OPERATOR_METADATA_DOWNTIME_RESET,
  ...
  'spot.image_capture.enabled': 'SPOT image capture',
  'spot.image_capture.mode': 'SPOT image capture mode',
  'spot.image_capture.path': 'SPOT image capture path',
  'spot.image_capture.min_interval_sec': 'SPOT image capture min interval',
  'spot.image_capture.max_bytes': 'SPOT image capture max bytes',
  'spot.image_capture.retention_days': 'SPOT image capture retention',
  'spot.image_capture.link_to_observation': 'SPOT image capture observation link',
