...
try:
    from backend.mes_bridge.collector import (
        login, 
        extract_table_data, 
        set_date_range, 
        get_all_pages_data,
    ...
    from backend.mes_bridge.db_manager import save_page_data
    from backend.mes_bridge.config_manager import get_credentials
...
import backend.mes_bridge.db_manager
backend.mes_bridge.db_manager.DB_PATH = TARGET_DB_PATH
