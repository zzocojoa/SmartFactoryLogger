...
DEFAULT_SPOT_IMAGE_CAPTURE_MODE = "off"
...
DEFAULT_SPOT_IMAGE_CAPTURE_SHUTDOWN_TIMEOUT_SEC = 30.0
MAX_SPOT_IMAGE_CAPTURE_SHUTDOWN_TIMEOUT_SEC = 30.0
...
MAX_CSV_LOGGER_CONTROL_SHUTDOWN_TIMEOUT_SEC = 300.0
...
SPOT_TIMEOUT = _get_float(CONFIG, "SPOT", "timeout", 3.0)
...
CSV_V1_ENABLED = _env_bool(
    "CSV_V1_ENABLED",
    _get_bool(CONFIG, "LOGGING", "csv_v1_enabled", DEFAULT_CSV_V1_ENABLED),
)
...
CSV_LOGGER_CONTROL_SHUTDOWN_TIMEOUT_SEC = min(
    MAX_CSV_LOGGER_CONTROL_SHUTDOWN_TIMEOUT_SEC,
    max(
        2.0,
        _env_float(
            "CSV_LOGGER_CONTROL_SHUTDOWN_TIMEOUT_SEC",
            _get_float(
                CONFIG,
                "LOGGING",
                "csv_logger_control_shutdown_timeout_sec",
                DEFAULT_CSV_LOGGER_CONTROL_SHUTDOWN_TIMEOUT_SEC,
            ),
        ),
    ),
)
SPOT_IMAGE_CAPTURE_SHUTDOWN_TIMEOUT_SEC = min(
    MAX_SPOT_IMAGE_CAPTURE_SHUTDOWN_TIMEOUT_SEC,
    max(
        2.0,
        _env_float(
            "SPOT_IMAGE_CAPTURE_SHUTDOWN_TIMEOUT_SEC",
            _get_float(
                CONFIG,
                "SPOT",
                "imagecaptureshutdowntimeoutsec",
                DEFAULT_SPOT_IMAGE_CAPTURE_SHUTDOWN_TIMEOUT_SEC,
            ),
        ),
    ),
)
